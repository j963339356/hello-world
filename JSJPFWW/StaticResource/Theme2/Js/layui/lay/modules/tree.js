...
layui.define("jquery", function(e) {
	...
	r.prototype.init = function(e) {
		...
		var a = this, i = (a.options, e.children(".layui-tree-spread")), r = e
				.children("ul"), n = e.children("a"), l = function() {
			e.data("spread") ? (e.data("spread", null), r
					.removeClass("layui-show"), i.html(t.arrow[0]), n
					.find(".layui-icon").html(t.branch[0])) : (e.data("spread",
					!0), r.addClass("layui-show"), i.html(t.arrow[1]), n
		...
		e.find("i").on("selectstart", function(e) {
			...
			if (i.from) {
				...
				var n = o("." + t)[0] ? o("." + t) : r;
				n.addClass("layui-show").html(i.from.elem.children("a").html()), n
						.css({
									left : e.pageX + 10,
									top : e.pageY + 10
								})
			...
			var e = a.move;
			e.from
					&& (e.from.elem.children("a").removeClass(i), e.to
		...
		t.on("mousedown", function() {
				...
				return t[0] ? void i.init(t) : a.error("layui.tree 没有找到"
						+ e.elem + "元素")
			})
});
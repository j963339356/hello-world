...
layui.define("layer", function(e) {
	...
	}, r = "upload", u = "layui-upload-file", c = "layui-upload-form", s = "layui-upload-iframe", f = "layui-upload-choose", p = function(
			e) {
		var t = this;
	...
	p.prototype.config = {
		...
		e.elem = i(e.elem), e.bindAction = i(e.bindAction), t.file(), t
				.events()
	}, p.prototype.file = function() {
		var e = this, t = e.config, n = e.elemFile = i([
				'<input class="' + u + '" type="file" name="' + t.field + '"',
				t.multiple ? " multiple" : "", ">"].join("")), o = t.elem
				.next();
		(o.hasClass(u) || o.hasClass(c)) && o.remove(), a.ie && a.ie < 10
				&& t.elem.wrap('<div class="layui-upload-wrap"></div>'), e
				.isFile()
				? (e.elemFile = t.elem, t.field = t.elem[0].name)
				: t.elem.after(n), a.ie && a.ie < 10 && e.initIE()
	}, p.prototype.initIE = function() {
		var e = this, t = e.config, n = i('<iframe id="' + s + '" class="' + s
				+ '" name="' + s + '" frameborder="0"></iframe>'), a = i([
				'<form target="' + s + '" class="' + c + '" method="'
						+ t.method,
				'" key="set-mine" enctype="multipart/form-data" action="'
						+ t.url + '">', "</form>"].join(""));
		i("#" + s)[0] || i("body").append(n), t.elem.next().hasClass(s)
				|| (e.elemFile.wrap(a), t.elem.next("." + s).append(function() {
					var e = [];
					return layui.each(t.data, function(i, t) {
								e.push('<input type="hidden" name="' + i
										+ '" value="' + t + '">')
							}), e.join("")
				}()))
		...
		if (e)
			return "input" === e.tagName.toLocaleLowerCase()
					&& "file" === e.type
		...
		var n, o = this, l = o.config, r = o.elemFile[0], u = function() {
			layui.each(e || o.files || o.chooseFiles || r.files,
					function(e, t) {
						var n = new FormData;
						n.append(l.field, t), layui.each(l.data,
								function(e, i) {
									n.append(e, i)
								}), i.ajax({
									url : l.url,
			...
			var e = i("#" + s);
			o.elemFile.parent().submit(), clearInterval(p.timer), p.timer = setInterval(
					function() {
			...
			if (o.elemFile.next("." + f).remove(), r.value = "", "object" != typeof i)
				try {
					i = JSON.parse(i)
				} catch (t) {
			...
			return "choose" === t ? l.choose && l.choose(g) : (l.before
		...
		var e = this, t = e.config, o = function(i) {
			...
			var a = e.elemFile, o = i.length > 1
					? i.length + "个文件"
					: (i[0] || {}).name || a[0].value.match(/[^\/\\]+\..+/g)
							|| [] || "";
			a.next().hasClass(f) && a.next().remove(), e.upload(null, "choose"), e
					.isFile()
					|| t.choose
					|| a.after('<span class="layui-inline ' + f + '">' + o
							+ "</span>")
		};
		t.elem.off("upload.start").on("upload.start", function() {
			...
			if (o)
				try {
					o = new Function("return " + o)(), e.config = i.extend({},
							t, o)
				} catch (l) {
					n
							.error("Upload element property lay-data configuration item has a syntax error: "
									+ o)
				}
			e.config.item = a, e.elemFile[0].click()
		}), a.ie && a.ie < 10
				|| t.elem.off("upload.over").on("upload.over", function() {
							var e = i(this);
							e.attr("lay-over", "")
				...
				|| (e.elemFile.on("change", function() {
							...
							e.preventDefault(), i(this).trigger("upload.drop",
									e)

...
(function(a) {
    ...
    a.fn.resetValue = function() {
        ...
        if (b.attr("trueType") == "select") {
            b.render();
            b.removeAttr("selectedvalue");
            b.removeAttr("relvalue");
            b.removeAttr("reltext");
        }
    };
...
jQuery.SelectBox = function(selectobj) {
    ...
    var $table = $('<table cellspacing="0" cellpadding="0" style="border-style:none;"><tr class="selectBox"><td class="ali01" style="border-style:none;padding:0;margin:0;"></td><td class="ali01 arrow""></td></tr></table>');
            ...
            if ($select.attr("openDirection") == "top") {
                ...
                if ($select.attr("openDirection") == "bottom") {
                    if (usefulHeight < oldHeight) {
                        $container.css({
                            //top: 28
                        	top: $mainCon.offset().top+$mainCon.height() //swq 20170928
                        });
